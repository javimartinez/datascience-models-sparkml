...
//import org.apache.spark.ml.feature.{ StringIndexerCustom$, VectorAssembler, VectorIndexer }
//import org.apache.spark.ml.tuning.{ CrossValidator, CrossValidatorModel, ParamGridBuilder }
//import org.apache.spark.sql.SparkSession
//
//object OneRClassifierExampleDeprecated {
//
...
//      (new StringIndexerCustom().setInputCol(column).setOutputCol(newColumn), newColumn)
//    }.toList.unzip
//
//    val assembler =
